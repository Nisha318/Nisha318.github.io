...
date: 2025-04-22
categories: ["Blog", "HackTheBox"]
tags: ["hackthebox", "windows", "initial-access", "ftp", "webdav", "metasploit", "privilege-escalation"]
summary: "This post is a walkthrough of the 'Devel' retired machine from Hack The Box. I gain initial access through an exposed FTP and WebDAV setup, then escalate privileges using MS15-051."
