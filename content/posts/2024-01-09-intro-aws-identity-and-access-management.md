...
summary: "A beginner-friendly walkthrough of managing users, groups, and permissions in AWS Identity and Access Management (IAM)."
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-users-list.png" alt="Pre-created IAM Users list in the AWS Console">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-user1-permissions.png" alt="IAM user-1 permissions tab">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-user1-groups.png" alt="IAM user-1 groups tab">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-user1-security-credentials.png" alt="IAM user-1 security credentials tab">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-user-groups-list.png" alt="Pre-created IAM User Groups in AWS Console">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-ec2support-group.png" alt="EC2-Support user group permissions">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-ec2readonly-json.png" alt="AmazonEC2ReadOnlyAccess policy JSON structure">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-s3support-group.png" alt="S3-Support user group permissions">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-s3readonly-json.png" alt="AmazonS3ReadOnlyAccess policy JSON structure">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-ec2admin-group.png" alt="EC2-Admin user group permissions">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-ec2admin-policy-json.png" alt="EC2-Admin inline policy JSON">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-s3support-add-user1.png" alt="user-1 added to the S3-Support Group">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-ec2support-add-user2.png" alt="user-2 added to the EC2-Support Group">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-ec2admin-add-user3.png" alt="user-3 added to the EC2-Admin Group">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-dashboard-signin-url.png" alt="IAM Dashboard showing sign-in URL for IAM users">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-user1-login.png" alt="IAM user-1 login screen">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-user1-s3buckets.png" alt="user-1 accessing Amazon S3 buckets">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-user2-ec2-unauthorized.png" alt="user-2 unauthorized EC2 access message">
...
<figure class="align-center">
  <img src="/assets/images/aws/iam/iam-user3-ec2instances.png" alt="user-3 viewing EC2 instances in AWS console">
