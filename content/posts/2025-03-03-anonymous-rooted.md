...
date: 2025-03-03
categories: ["Blog", "TryHackMe"]
tags: ["TryHackMe", "initial-access", "ftp", "reverse-shell", "linux", "privilege-escalation", "suid"]
summary: "This walkthrough covers the TryHackMe 'Anonymous' room. I gain user-level access via FTP and a writable script, capture the user flag, and escalate to root via a SUID misconfiguration."
